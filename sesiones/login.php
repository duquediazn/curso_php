<?php
    ...
    if(!preg_match("/^[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ() ]{3,10}/", $_POST['usuario'])) {//https://www.php.net/manual/es/function.preg-match.php
        echo "El usuario no coincide con el formato solicitado.";
        exit();
    }

    if(!preg_match("/^[a-zA-Z0-9$@.-]{4,30}/", $_POST['clave'])) {//https://www.php.net/manual/es/function.preg-match.php
