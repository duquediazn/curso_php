...
- is_subclass_if(objeto, 'Clase') : Devuelve true si el objeto o la clase del primer parámetro tiene como 
...
En este caso no se podrían crearclases heredadas utilizándola como base
*/
...
pero en lugar de prohibir la herencia, obligaa que se herede. 
Es decir, una clase con el modificador abstract no puede tener objetos quela instancien, 
pero sí podrá utilizarse de clase base y sus subclases sí podrán utilizarse parainstanciar 
objetos.
...
/*
Obviamente puedes definir un nuevo constructor paralas clases heredadas que redefinan 
...
base si loconsideras necesario, utilizando para ello la palabra
